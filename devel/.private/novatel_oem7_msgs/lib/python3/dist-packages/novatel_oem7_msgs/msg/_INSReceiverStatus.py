...
"""autogenerated by genpy from novatel_oem7_msgs/INSReceiverStatus.msg. Do not edit."""
import codecs
import sys
...
class INSReceiverStatus(genpy.Message):
  _md5sum = "cef3d5bf695a9baf478785be4d0a7dbe"
  _type = "novatel_oem7_msgs/INSReceiverStatus"
...
uint8[4]         status"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(INSReceiverStatus, self).__init__(*args, **kwds)
