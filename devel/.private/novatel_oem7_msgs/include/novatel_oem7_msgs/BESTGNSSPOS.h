// Generated by gencpp from file novatel_oem7_msgs/BESTGNSSPOS.msg
// DO NOT EDIT!


#ifndef NOVATEL_OEM7_MSGS_MESSAGE_BESTGNSSPOS_H
#define NOVATEL_OEM7_MSGS_MESSAGE_BESTGNSSPOS_H
...
struct BESTGNSSPOS_
{
  ...
  typedef boost::shared_ptr< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> const> ConstPtr;

}; // struct BESTGNSSPOS_

typedef ::novatel_oem7_msgs::BESTGNSSPOS_<std::allocator<void> > BESTGNSSPOS;

typedef boost::shared_ptr< ::novatel_oem7_msgs::BESTGNSSPOS > BESTGNSSPOSPtr;
typedef boost::shared_ptr< ::novatel_oem7_msgs::BESTGNSSPOS const> BESTGNSSPOSConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator1> & lhs, const ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> >
{
  ...
  static const char* value(const ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x31b3dab4b00d6508ULL;
  static const uint64_t static_value2 = 0x367964c5496f9450ULL;
};

template<class ContainerAllocator>
struct DataType< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::novatel_oem7_msgs::BESTGNSSPOS_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // NOVATEL_OEM7_MSGS_MESSAGE_BESTGNSSPOS_H
