// Generated by gencpp from file novatel_oem7_msgs/BESTPOS.msg
// DO NOT EDIT!


#ifndef NOVATEL_OEM7_MSGS_MESSAGE_BESTPOS_H
#define NOVATEL_OEM7_MSGS_MESSAGE_BESTPOS_H
...
struct BESTPOS_
{
  ...
  typedef boost::shared_ptr< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> const> ConstPtr;

}; // struct BESTPOS_

typedef ::novatel_oem7_msgs::BESTPOS_<std::allocator<void> > BESTPOS;

typedef boost::shared_ptr< ::novatel_oem7_msgs::BESTPOS > BESTPOSPtr;
typedef boost::shared_ptr< ::novatel_oem7_msgs::BESTPOS const> BESTPOSConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator1> & lhs, const ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> >
{
  ...
  static const char* value(const ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x31b3dab4b00d6508ULL;
  static const uint64_t static_value2 = 0x367964c5496f9450ULL;
};

template<class ContainerAllocator>
struct DataType< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::novatel_oem7_msgs::BESTPOS_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // NOVATEL_OEM7_MSGS_MESSAGE_BESTPOS_H
