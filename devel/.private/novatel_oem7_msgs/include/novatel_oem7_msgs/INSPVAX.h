// Generated by gencpp from file novatel_oem7_msgs/INSPVAX.msg
// DO NOT EDIT!


#ifndef NOVATEL_OEM7_MSGS_MESSAGE_INSPVAX_H
#define NOVATEL_OEM7_MSGS_MESSAGE_INSPVAX_H
...
struct INSPVAX_
{
  ...
  _nov_header_type nov_header;
   ...
   typedef  ::novatel_oem7_msgs::InertialSolutionStatus_<ContainerAllocator>  _ins_status_type;
  ...
  typedef boost::shared_ptr< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> const> ConstPtr;

}; // struct INSPVAX_

typedef ::novatel_oem7_msgs::INSPVAX_<std::allocator<void> > INSPVAX;

typedef boost::shared_ptr< ::novatel_oem7_msgs::INSPVAX > INSPVAXPtr;
typedef boost::shared_ptr< ::novatel_oem7_msgs::INSPVAX const> INSPVAXConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator1> & lhs, const ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> >
{
  ...
  static const char* value(const ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xed91b0a9b45cec79ULL;
  static const uint64_t static_value2 = 0xc5555245c5db0a4eULL;
};

template<class ContainerAllocator>
struct DataType< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::novatel_oem7_msgs::INSPVAX_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "ins_status: ";
    s << std::endl;
    Printer< ::novatel_oem7_msgs::InertialSolutionStatus_<ContainerAllocator> >::stream(s, indent + "  ", v.ins_status);
    s << indent << "pos_type: ";
    s << std::endl;
...
#endif // NOVATEL_OEM7_MSGS_MESSAGE_INSPVAX_H
