...
if("TRUE" STREQUAL "TRUE")
  set(annotate_SOURCE_PREFIX /home/terry/mr23_ws/src/annotate)
  set(annotate_DEVEL_PREFIX /home/terry/mr23_ws/devel/.private/annotate)
  set(annotate_INSTALL_PREFIX "")
  set(annotate_PREFIX ${annotate_DEVEL_PREFIX})
else()
  set(annotate_SOURCE_PREFIX "")
  set(annotate_DEVEL_PREFIX "")
  set(annotate_INSTALL_PREFIX /home/terry/mr23_ws/install)
...
if(NOT "/home/terry/mr23_ws/src/annotate/include " STREQUAL " ")
  set(annotate_INCLUDE_DIRS "")
  set(_include_dirs "/home/terry/mr23_ws/src/annotate/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'annotate' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/terry/mr23_ws/src/annotate/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/terry/mr23_ws/devel/.private/annotate/lib;/home/terry/mr23_ws/devel/lib;/opt/ros/noetic/lib)
...
set(depends "geometry_msgs;interactive_markers;roscpp;rviz;tf;visualization_msgs")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(annotate_EXPORTED_TARGETS ${${annotate_dep}_EXPORTED_TARGETS})
endforeach()
